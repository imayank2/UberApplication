...
-- Create driver profiles with Delhi/NCR locations
INSERT INTO driver (user_id, rating, available, current_location) VALUES
                                                                      (2, 4.7, true, ST_SetSRID(ST_MakePoint(77.1025, 28.7041), 4326)),   -- Connaught Place
                                                                      (3, 4.8, true, ST_SetSRID(ST_MakePoint(77.2167, 28.6667), 4326)),   -- South Delhi
                                                                      (4, 4.6, true, ST_SetSRID(ST_MakePoint(77.2273, 28.6353), 4326)),   -- Greater Kailash
                                                                      (5, 4.9, true, ST_SetSRID(ST_MakePoint(77.2500, 28.5500), 4326)),   -- Gurugram
                                                                      (6, 4.3, true, ST_SetSRID(ST_MakePoint(77.2000, 28.6200), 4326)),   -- Nehru Place
                                                                      (7, 4.4, true, ST_SetSRID(ST_MakePoint(77.2800, 28.5900), 4326)),   -- Noida
                                                                      (8, 4.5, true, ST_SetSRID(ST_MakePoint(77.2600, 28.6800), 4326)),   -- North Campus
                                                                      (9, 4.6, true, ST_SetSRID(ST_MakePoint(77.2200, 28.6400), 4326)),   -- Saket
                                                                      (10, 4.7, true, ST_SetSRID(ST_MakePoint(77.2700, 28.6700), 4326));  -- East Delhi

-- Initialize wallets with balances
