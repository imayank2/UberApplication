-- 1. Create tables with Redshift-compatible syntax
...
INSERT INTO driver (user_id, rating, available, longitude, latitude) VALUES
                                                                         (2, 4.7, TRUE, 77.1025, 28.7041),
                                                                         (3, 4.8, TRUE, 77.2167, 28.6667),
                                                                         (4, 4.6, TRUE, 77.2273, 28.6353),
                                                                         (5, 4.9, TRUE, 77.2500, 28.5500),
                                                                         (6, 4.3, TRUE, 77.2000, 28.6200),
                                                                         (7, 4.4, TRUE, 77.2800, 28.5900),
                                                                         (8, 4.5, TRUE, 77.2600, 28.6800),
                                                                         (9, 4.6, TRUE, 77.2200, 28.6400),
                                                                         (10, 4.7, TRUE, 77.2700, 28.6700);
